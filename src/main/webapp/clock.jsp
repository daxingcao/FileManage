...
<body>
	<div class="fill">
		...
		<div class="clock" id="utility-clock" style="transform: scale(0.789);">
			<div class="centre">
				<div class="dynamic">
				...
				<div class="anchor hour" style="transform: rotate(523.553deg);">
					<div class="element thin-hand"></div>
					<div class="element fat-hand"></div>
				</div>
				<div class="anchor minute" style="transform: rotate(6282.63deg);">
					<div class="element thin-hand"></div>
					<div class="element fat-hand minute-hand"></div>
				</div>
				<div class="anchor second" style="transform: rotate(376958deg);">
